...
public class ImagenP {
    ...
    private ListaImagen imagen;

    public ImagenP(String name, String path_, ImagenP next,ImagenP back) {
        this.imagen =  new ListaImagen();
        this.name = name;
        this.path_ = path_;
        this.next = next;
        this.back = back;
    ...
    public ListaImagen getImagen() {
        return imagen;
    }

    public void setImagen(Listas galeria) {
        this.imagen = imagen;
    }
    ...
    public ImagenP(String name, String ruta) {
        this.name = name;
        this.path_ = ruta;
    }
